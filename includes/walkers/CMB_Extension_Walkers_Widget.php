 ...
 */
class CMB_Extension_Walkers_Widget extends WP_Widget {
	 ...
	 * @var string
	 */
	protected $widget_slug = 'cmb2-ext-widget';
	 ...
	 * @var string
	 */
	protected static $shortcode = 'cmb2_ext_widget';
 ...
 */
function register_cmb2_ext_widget() {
	register_widget( 'CMB2_Ext_Widget' );
}
//add_action( 'widgets_init', 'register_cmb2_ext_widget' );
